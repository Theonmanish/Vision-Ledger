    ...
    >
      ...
      <div className="relative overflow-hidden rounded-2xl border border-white/[0.08] bg-[#111113]/60 p-4 backdrop-blur-2xl sm:p-6 lg:p-8">
        ...
        <motion.div
          ...
          animate={{ opacity: 1 }}
          transition={{ duration: 0.5, delay: reduceMotion ? 0 : 1.2 }}
          className="relative z-10 mt-4 grid grid-cols-2 gap-2 border-t border-white/[0.08] pt-4 sm:mt-6 sm:grid-cols-4 sm:gap-3"
        >
          {[
